...
/** Loading state for Projects grid — matches People cards (1 / 2 / 3 / 4 / 5 cols). */
export function ProjectsGridSkeleton({ cards = 10 }: { cards?: number }) {
  return (
    <div
        ...
        <div key={i} className={`${glassCard} flex flex-col overflow-hidden`}>
          ...
          <div className="mt-auto space-y-3 rounded-t-[16px] bg-slate-200/50 px-5 py-4">
            <div className="flex justify-between gap-2">
              ...
              <div className="h-3 w-20 animate-pulse rounded bg-slate-300/80" />
            </div>
            <div className="flex justify-between gap-2">
