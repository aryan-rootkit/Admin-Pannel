...
export function TopBar({ onMenuClick }: Props) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200/90 bg-white/95 shadow-[0_1px_0_0_rgba(15,23,42,0.06)]">
      <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-3 px-4 py-3.5 sm:px-6 sm:py-4 lg:px-10">
        <div className="flex min-w-0 items-center gap-2">
          {onMenuClick ? (
            <button
              type="button"
              className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-200/90 bg-white text-slate-800 shadow-sm transition hover:bg-slate-50 md:hidden"
          ...
          <span className="truncate text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 md:hidden">
            Menu
          </span>
        </div>
        ...
        <div className="hidden min-w-0 flex-1 justify-center px-3 md:flex">
          <div className="relative w-full max-w-[560px]">
            ...
            <Input
              ...
              className="h-11 rounded-full border border-slate-200/90 bg-white pl-11 pr-4 shadow-sm ring-0 placeholder:text-slate-400 focus:border-blue-400/50 focus:ring-2 focus:ring-blue-500/15"
            />
          </div>
        </div>
          ...
          {isLoggedIn ? (
            <>
              ...
              <Button
                type="button"
                variant="ghost"
                className="min-h-11 rounded-full px-4 text-xs font-semibold text-slate-600 sm:min-h-10 hover:bg-slate-100 hover:text-slate-900"
