    ...
    tasks: [
      {
        ...
        priority: 'high',
        assignee: { name: 'Sarah Chen', avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=200&q=80' },
        tags: ['Design', 'System'],
        dueDate: '2024-01-15',
        attachments: 3,
        comments: 7,
      },
      {
        ...
        priority: 'medium',
        assignee: { name: 'Alex Rivera', avatar: 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=200&q=80' },
        tags: ['Research', 'UX'],
        dueDate: '2024-01-18',
        comments: 4,
      },
    ...
    tasks: [
      {
        ...
        priority: 'high',
        assignee: { name: 'Jordan Kim', avatar: 'https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=crop&w=200&q=80' },
        tags: ['Mobile', 'UI'],
        attachments: 8,
        comments: 12,
      },
    ...
    tasks: [
      {
        ...
        priority: 'medium',
        assignee: { name: 'Maya Patel', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80' },
    ...
    tasks: [
      {
        ...
        priority: 'low',
        assignee: { name: 'Chris Wong', avatar: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=200&q=80' },
        tags: ['Marketing', 'Web'],
        attachments: 2,
        comments: 8,
      },
  ...
  return (
    <div className="">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-light text-neutral-900 dark:text-neutral-100 mb-2">Kanban Board</h1>
                  ...
                  <CardContent className="p-5">
                    <div className="space-y-4">
                      <div className="flex items-start justify-between">
                        <h4 className="font-semibold text-neutral-900 dark:text-neutral-100 leading-tight">{task.title}</h4>
                        <GripVertical className="w-5 h-5 text-neutral-500 dark:text-neutral-400 cursor-move" />
                      </div>

                      {task.description && (
                        <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed">{task.description}</p>
                      )}
