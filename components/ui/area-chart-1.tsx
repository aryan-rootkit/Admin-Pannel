...
const initialChartData: ChartSeries[] = [
  {
    key: 'DLP',
    data: [
      { key: generateDate(6), data: 30 },
      { key: generateDate(5), data: 45 },
      { key: generateDate(4), data: 40 },
      { key: generateDate(3), data: 60 },
      { key: generateDate(2), data: 50 },
      { key: generateDate(1), data: 70 },
  ...
  },
  {
    key: 'Threat Intel',
    data: [
      { key: generateDate(6), data: 10 },
      { key: generateDate(5), data: 15 },
      { key: generateDate(4), data: 12 },
      { key: generateDate(3), data: 20 },
      { key: generateDate(2), data: 18 },
      { key: generateDate(1), data: 25 },
  ...
  },
  {
    key: 'SysLog',
    data: [
      { key: generateDate(6), data: 20 },
      { key: generateDate(5), data: 25 },
      { key: generateDate(4), data: 30 },
      { key: generateDate(3), data: 22 },
      { key: generateDate(2), data: 35 },
      { key: generateDate(1), data: 40 },
      ...
      <div className="flex flex-col pt-4 pb-4 bg-white dark:bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-full max-w-md min-h-[580px] overflow-hidden transition-colors duration-300">
        ...
        <div className="reaviz-chart-container h-[200px]">
          <AreaChart
            ...
            yAxis={<LinearYAxis axisLine={null} tickSeries={<LinearYAxisTickSeries line={null} label={null} tickSize={10} />} />}
            series={
              <AreaSeries
                type="grouped"
